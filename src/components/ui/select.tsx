  ...
  return (
    <SelectPrimitive.Portal>
      <SelectPrimitive.Content
        ...
        {...props}
      >
        {position === "item-aligned" ? <SelectScrollUpButton /> : null}
        <SelectPrimitive.Viewport
          data-position={position}
          className={cn(
            "p-1 max-h-64 overflow-y-auto [scrollbar-width:thin]",
            position === "popper" &&
        ...
        {position === "item-aligned" ? <SelectScrollDownButton /> : null}
      </SelectPrimitive.Content>
    </SelectPrimitive.Portal>
  )
}
