...
| `[x]` | **Permissions & Ownership Modal (`chmod`/`chown`)** | Right-click inspector to modify octal permissions (`755`, `644`, `600`), ownership (`chown`), and SSH sudo elevation fallback. | v1.2 |
